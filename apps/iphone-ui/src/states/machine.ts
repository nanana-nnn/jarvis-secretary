...
const transitions: Partial<Record<SecretaryState, Partial<Record<SecretaryEvent, SecretaryState>>>> = {
  ...
  SLEEP: { CLAP_DETECTED: "WAKING", TAP_DETECTED: "WAKING", DISCONNECTED: "OFFLINE", SYSTEM_ERROR: "ERROR" },
  ...
  LISTENING: { AUDIO_FINAL: "TRANSCRIBING", AGENT_STARTED: "THINKING", IDLE: "SLEEP", DISCONNECTED: "OFFLINE", SYSTEM_ERROR: "ERROR" },
  ...
  SPEAKING: { AGENT_STARTED: "THINKING", IDLE: "SLEEP", FINISH: "SLEEP", CONTINUE: "LISTENING", DISCONNECTED: "OFFLINE", SYSTEM_ERROR: "ERROR" },
